...
import { mainRoutes, adminRoutes } from "@/routes/mainRoutes";


const styles ={
  container:`h-full w-58 bg-dark-light-background border-r border-gray-400  px-6 py-10 text-black fixed top-0`,
...
const SideNavbar=()=>{
  ...
  <nav className={styles.container}>
      ...
      <div className="mt-16 h-[75%] overflow-scroll overflow-x-hidden overflow-y-hidden ">
          ...
          <p className="font-medium text-gray-500 mb-2 mt-5">ADMIN</p>
          <ul className="list-none">
              {
